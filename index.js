...
function handleStatusPage() {
  const h = [
    ...
    '<p class="text-slate-500 mb-8">系統正常運行中。</p>',
    '<a href="/admin" class="block bg-blue-600 text-white py-4 rounded-xl font-medium shadow-lg transition hover:bg-blue-700 text-lg">進入管理後台</a>',
    '</div></body></html>'
  ].join("");
