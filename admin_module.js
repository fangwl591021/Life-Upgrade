...
export async function handleAdminPage(env) {
  const h = [
    ...
    '<title>管理控制台 - 人生進化 Action</title><script src="https://cdn.tailwindcss.com"></script>',
    ...
    '<button onclick="st(\'orders\')" id="n-orders" class="flex items-center w-full p-3 text-slate-500 hover:bg-slate-50 rounded-xl transition font-medium text-base">📜 訂單記錄</button>',
    ...
    '</nav><div class="p-6 border-t border-slate-100 text-center"><button onclick="location.reload()" class="text-xs text-slate-400 font-bold hover:text-red-500 uppercase transition tracking-widest">Logout</button></div></aside>',
    ...
    's.innerHTML=\'<div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden font-sans"><table class="w-full text-left">\'+\'<thead class="bg-slate-50 text-[11px] text-slate-400 font-bold uppercase border-b border-slate-100"><tr><th class="p-5 text-base">單號</th><th class="p-5 text-base">報名學員</th><th class="p-5 text-base">課程</th><th class="p-4 text-base">金額</th><th class="p-5 text-center text-base">狀態</th><th class="p-5 text-right font-semibold text-base">管理</th></tr></thead><tbody class="text-sm">\'+rows+\'</tbody></table></div>\';',
    ...
    's.innerHTML=\'<div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden font-sans"><table class="w-full text-left">\'+\'<thead class="bg-slate-50 text-[11px] text-slate-400 font-bold uppercase border-b border-slate-100"><tr><th class="p-5 text-base">真實姓名</th><th class="p-5 text-base">聯絡手機</th><th class="p-5 text-base">UID</th><th class="p-5 text-right font-semibold text-base">註冊日期</th></tr></thead><tbody>\'+rows+\'</tbody></table></div>\';',
    '}',
    '}',
    '</script></body></html>'
  ].join("\n");
